...
ggplot(median_proportions_wide, aes(
  x = amel, y = bter, color = subunit, shape = subunit
)) +
  ...
  labs(
    title = "Median proportion of nAChR expression in queen brains",
    x = expression(paste(
      "Median proportion of nAChR expression in ", italic("A. mellifera")
    )),
    y = expression(paste(
      "Median proportion of nAChR expression in ", italic("B. terrestris")
    ))
  )
