...
bter_nachrs_counts <- bter_counts %>%
  ...
  dplyr::mutate(tissue = case_when(
    ...
    grepl("queen_adult", sample) ~ "whole_body_queen_adult",
    grepl("worker_adult_repr", sample) ~ "whole_body_worker_adult_repr",
    grepl("worker_adult_undet", sample) ~ "whole_body_worker_adult_undet",
    grepl("worker_larva", sample) ~ "whole_body_worker_larva",
    grepl("worker_pupa", sample) ~ "whole_body_worker_pupa"
  )) %>%
  dplyr::mutate(caste = case_when(
